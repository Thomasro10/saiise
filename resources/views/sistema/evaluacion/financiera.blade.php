...
@section('content')
    ...
    <div class="modal fade" id="detalleEvaFinanciera" tabindex="-1" role="dialog" aria-labelledby="simpleModalLabel" aria-hidden="true">
                ...
                <div class="modal-body">
                    <div class="card card-bordered style-primary">
                        <div class="card-head">
                            ...
                            <header>Detalle Evaluación Financiera</header>
                        </div><!--end .card-head -->
                        <div class="card-body style-default-bright">
                            <div id="divEvaFinDet"></div>
                        </div><!--end .card-body -->
                    </div><!--end .card -->
                </div>
            ...
            <div class="modal-content">
                <div class="modal-body">
                    <form class="form form-validate" role="form" id="addEmp" novalidate >
                        ...
                        <input type="hidden" name="id_evafinanciera" id="id_evafinanciera">
                        ...
                        <div class="card">
                            <div class="card-head style-primary">
                                ...
                                <header>Evaluación Financiera</header>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-6">
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <select id="afinanciero" name="afinanciero" class="form-control objeto" required>
                                                <option value="">&nbsp;</option>
                                                <option value="SI">SI</option>
                                                <option value="NO">NO</option>
                                            </select>
                                            <label for="afinanciero">Tiene análisis financiero</label>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <select id="cproduccion" name="cproduccion" class="form-control objeto" required>
                                                <option value="">&nbsp;</option>
                                                <option value="SI">SI</option>
                                                <option value="NO">NO</option>
                                            </select>
                                            <label for="cproduccion">Tiene costos de producción</label>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <select id="gadminventas" name="gadminventas" class="form-control objeto" required>
                                                <option value="">&nbsp;</option>
                                                <option value="SI">SI</option>
                                                <option value="NO">NO</option>
                                            </select>
                                            <label for="gadminventas">Tiene gastos administrativos-ventas</label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <select id="ingresos" name="ingresos" class="form-control objeto" required>
                                                <option value="">&nbsp;</option>
                                                <option value="SI">SI</option>
                                                <option value="NO">NO</option>
                                            </select>
                                            <label for="ingresos">Tiene ingresos</label>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <select id="efinancieros" name="efinancieros" class="form-control objeto" required>
                                                <option value="">&nbsp;</option>
                                                <option value="SI">SI</option>
                                                <option value="NO">NO</option>
                                            </select>
                                            <label for="efinancieros">Tiene estados financieros</label>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <select id="acostos" name="acostos" class="form-control objeto" required>
                                                <option value="">&nbsp;</option>
                                                <option value="SI">SI</option>
                                                <option value="NO">NO</option>
                                            </select>
                                            <label for="acostos">Tiene análisis de costo</label>
                                        </div>
                                    </div>
                                </div>
       ...
       $(function() {
            ...
            table = $('#dt_emp').DataTable({
               ...
               dom: 'Blfrtip',
                ...
                ajax: {
                    url: '{!! route('sistema.eproyecto.financiera.data') !!}',
                    data: function (d) {
           ...
           addEvaFinanciera= function(id, ced, nom){
               $.ajax({
                   type: "POST",
                   url:'{!! route('sistema.eproyecto.financiera.find') !!}',
                       ...
                       if(data.sol_id != 0){
                           if(data.msj != '0' ){
                               ...
                               $.each(data.info, function(i, item) {
                                   $("#id_evafinanciera").val(item.id);
                                   $("#id_sol").val(item.sol_id);
                                   $("#fecha").val(item.fecha);

                                   $('#afinanciero').append($('<option>').text(item.afinanciero).attr({value: item.afinanciero, selected: "selected"}));
                                   $('#cproduccion').append($('<option>').text(item.cproduccion).attr({value: item.cproduccion, selected: "selected"}));
                                   $('#gadminventas').append($('<option>').text(item.gadminventas).attr({value: item.gadminventas, selected: "selected"}));
                                   $('#ingresos').append($('<option>').text(item.ingresos).attr({value: item.ingresos, selected: "selected"}));
                                   $('#efinancieros').append($('<option>').text(item.efinancieros).attr({value: item.efinancieros, selected: "selected"}));
                                   $('#acostos').append($('<option>').text(item.acostos).attr({value: item.acostos, selected: "selected"}));
                                   $('#responsable').val(ced);
           ...
           $('#btnAddOfic').click(function(){
               if(fAddEmp.valid()){
                   $.ajax({
                       type: "POST",
                       url:'{!! route('sistema.eproyecto.financiera.add') !!}',
           ...
           $('#formAddEmp').on('hidden.bs.modal', function (e) {
               if($('#id_evafinanciera').val() != ''){
                   $("#afinanciero option:last, #cproduccion option:last, #gadminventas option:last, #ingresos option:last, #efinancieros option:last, #acostos option:last, #responsable option:last, #verificado option:last").remove();
                   $('#id_evafinanciera').val('');
               }
               fAddEmp.clearForm();
               $("#observacion").val('SIN OBSERVACION');
           })

           viewEvaFinanciera= function(id){
               $.ajax({
                   type: "POST",
                   url:'{!! route('sistema.eproyecto.financiera.view') !!}',
                   data: {"_token": "{{ csrf_token() }}", "id": id},
                   success: function( data ) {
                       if(data.sol_id != 0){
                           if(data.msj != '0' ){
                               ...
                               $.each(data.info, function(i, item) {
                                   ...
                                   html = "<div class='row'>" +
                                       ...
                                       "</div>"+
                                       "<div class='row'>" +
                                       "<div class='col-md-4'>Análisis financiero: <strong class='text-ultra-bold'>"+item.afinanciero+"</strong></div>" +
                                       "<div class='col-md-4'>Costos de producción: <strong class='text-ultra-bold'>"+item.cproduccion+"</strong></div>" +
                                       "<div class='col-md-4'>Gastos administrativos-ventas: <strong class='text-ultra-bold'>"+item.gadminventas+"</strong></div>" +
                                       "</div>"+
                                       "<div class='row'>" +
                                       "<div class='col-md-4'>Ingresos: <strong class='text-ultra-bold'>"+item.ingresos+"</strong></div>" +
                                       "<div class='col-md-4'>Estados financieros: <strong class='text-ultra-bold'>"+item.efinancieros+"</strong></div>" +
                                       "<div class='col-md-4'>Análisis de costo: <strong class='text-ultra-bold'>"+item.acostos+"</strong></div>" +
                                       "</div>"+
                                       "<div class='row'>" +
                                   ...
                                   $('#divEvaFinDet').empty().html(html);

                               })
                               $('#detalleEvaFinanciera').modal('show');
                           }
           ...
           $('#detalleEvaFinanciera').on('hidden.bs.modal', function (e) {
               $('#divEvaEcoDet').empty();
           })

           delEvaFinanciera = function(id){
               swal({
                   ...
                   $.ajax({
                       type: "POST",
                       url:'{!! route('sistema.eproyecto.financiera.del') !!}',
                       data: {"_token": "{{ csrf_token() }}", "id": id},
                       success: function( data ) {
                           if(data.status == 1){
                               swal(data.msg, "", "success");
