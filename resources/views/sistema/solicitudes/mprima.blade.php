                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <input type="text" class="form-control" id="descripcion2" name="descripcion" required onfocus="getMPrimaMedida('descripcion2', '{!! route('sistema.getMtriaPrima') !!}')">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <input type="text" data-type="number" data-rule-digits="true" class="form-control" id="cantidad2" name="cantidad" required>
                                            <label for="cantidad2">Cantidad por mes</label>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <input type="text" class="form-control" id="medida2" name="medida" required onfocus="getMPrimaMedida('medida2', '{!! route('sistema.getMPMedida') !!}')">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <input type="text" class="form-control" id="solicitud2" name="solicitud" onfocus="getSolicitud('solicitud', 'id_sol', '{!! route('sistema.getSolicitudMPrima') !!}')" required >
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <input type="text" class="form-control" id="descripcion" name="descripcion" required onfocus="getMPrimaMedida('descripcion', '{!! route('sistema.getMtriaPrima') !!}')">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <input type="text" data-type="number" data-rule-digits="true" class="form-control" id="cantidad" name="cantidad" required>
                                            <label for="cantidad">Cantidad por mes</label>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <input type="text" class="form-control" id="medida" name="medida" required onfocus="getMPrimaMedida('medida', '{!! route('sistema.getMPMedida') !!}')">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <input type="text" class="form-control" id="solicitud" name="solicitud" onfocus="getSolicitud('solicitud', 'id_sol', '{!! route('sistema.getSolicitudMPrima') !!}')" required >
        ...
        $(function() {
            ...
            table = $('#dt_emp').DataTable({
               ...
               dom: 'Blfrtip',
                ...
                { data: 'medida', name: 'mprima.medida' },
