...
Route::get('/ficha', function () {
    return view('sistema.visitas.ficha');
});
...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::post('/visitas/find', ['uses' => 'VisitaController@buscarVisitas','as' => 'sistema.visitas.find']);
    Route::post('/visitas/actualizar',['uses' => 'VisitaController@actualizarVisitas','as' => 'sistema.visitas.upd']);
    Route::post('/visitas/eliminar',['uses' => 'VisitaController@eliminarVisitas','as' => 'sistema.visitas.del']);
    Route::get('/visitas/view',['uses' => 'VisitaController@verFichaVisita','as' => 'sistema.visitas.view']);
    Route::post('/visitas/upload',['uses' => 'VisitaController@subirFoto','as' => 'sistema.visitas.upl']);
    Route::post('/visitas/delfoto',['uses' => 'VisitaController@eliminarFoto','as' => 'sistema.visitas.delfoto']);
    Route::get('/visitas/ficha',['uses' => 'VisitaController@generarFicha','as' => 'sistema.visitas.ficha']);


    Route::post('/visitas/produccion/add',['uses' => 'VisitaController@agregarVProduccion','as' => 'sistema.visitas.produccion.add']);
    Route::post('/visitas/produccion/data', ['uses' => 'VisitaController@getDataPro','as' => 'sistema.visitas.produccion.data']);
    Route::post('/visitas/produccion/del', ['uses' => 'VisitaController@eliminarProduccion','as' => 'sistema.visitas.produccion.del']);

    Route::post('/visitas/mprima/add',['uses' => 'VisitaController@agregarVMPrima','as' => 'sistema.visitas.mprima.add']);
    Route::post('/visitas/mprima/data', ['uses' => 'VisitaController@getDataMPrima','as' => 'sistema.visitas.mprima.data']);
    Route::post('/visitas/mprima/del', ['uses' => 'VisitaController@eliminarMPrima','as' => 'sistema.visitas.mprima.del']);

    Route::post('/visitas/comercial/add',['uses' => 'VisitaController@agregarComercializacion','as' => 'sistema.visitas.comercial.add']);
    Route::post('/visitas/comercial/data', ['uses' => 'VisitaController@getDataComercializacion','as' => 'sistema.visitas.comercial.data']);
    Route::post('/visitas/comercial/del', ['uses' => 'VisitaController@eliminarComercializacion','as' => 'sistema.visitas.comercial.del']);

    Route::post('/visitas/inversion/add',['uses' => 'VisitaController@agregarInvPer','as' => 'sistema.visitas.inversion.add']);
    Route::post('/visitas/inversion/data', ['uses' => 'VisitaController@getDataInvPer','as' => 'sistema.visitas.inversion.data']);
    Route::post('/visitas/inversion/del', ['uses' => 'VisitaController@eliminarInvPer','as' => 'sistema.visitas.inversion.del']);
...
Route::get('/visitas/prueba',['uses' => 'VisitaController@prueba','as' => 'sistema.visitas.prueba']);
